...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação do tratamento inicial do doente em condição crítica (até 1ª. hora)', 30);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Polipectomia do rectosigmoide com tubo rígido (incluindo exame endoscópico)', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Polipectomia do tubo digestivo a adicionar ao respectivo exame endoscópico', 10);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Terapêutica hemostática (não varicosa) a adicionar ao respectivo exame endoscópico', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Terapêutica por raio laser a adicionar ao respectivo exame endoscópico (cada sessão)', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Litotripsia biliar extracorporal', 50);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Teste Respiratório com Carbono 13 (diagnóstico da infecção pelo Helicobacter pylori)', 3);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame oftalmológico completo sob anestesia geral, com ou sem manipulação do globo ocular, para diagnóstico inicial, relatório médico', 30);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação da visão binocular de perto e longe com testes subjectivos de fixação', 6);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Adaptação de lentes de contacto com fins terapêuticos (não inclui o preço da lente)', 12);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação de campos visuais, exame limitado (estimulos simples/equivalentes)', 12);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação dos campos visuais, exame intermédio (estimulos múltiplos, compo completo, vária esoptéras no perímetro Goldmann/equivalente)', 18);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação dos campos visuais, exame extenso (perimetria quantitativa, estática ou cinética)', 30);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Elaboração de relatório médico com base nos elementos do processo clínico', 12);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Oftalmoscopia indirecta completa (inclui interposição lente, desenho/esquema/e/ou biomicroscopia do fundo)', 20);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fotografia especial do segmento anterior, com ou sem microscopia especular', 25);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação da acuidade visual por técnicas diferenciadas (interferometria, visão de sensibilidade ao contraste, visão mesópica e escotópica/outras)', 15);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Electronistagmografia e/ou electro-oculograma dinâmico com teste de nistagmo optocinético', 35);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ecografia oftalmica linear, análise espectral com quantificação da amplitude', 15);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Biometria oftalmica por ecografia linear com cálculo de potência da lente intraocular', 15);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Biometria oftalmica por ecografia linear com cálculo da espessura da córnea, paquimetria', 15);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ecografia oftalmica para localização de corpos estranhos', 15);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Localização radiológica de corpo estranho da região orbitária (anel Comberg/equivalente)', 15);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Biomicroscopia do fundo ocular ou visão camerular com lente de Goldmann', 10);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Estudo auditivo completo (audiometria tonal e vocal, impedância, prova de fadiga e recobro)', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Testes suplementares de audiometria (Tone Decay, Sisi, recobro, etc.) cada', 8);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Acufenometria', 5);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Optimização do ganho auditivo de performance electro-acústica das próteses auditivas "in situ"', 10);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Timpanograma, incluindo a medição de compliance e volume do conduto externo', 8);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Estudo timpanométrico do funcionamento da Trompa de Eustáquio (medição feita com ponte de admitância)', 5);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Provas suplementares de timpanometria', 5);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Impedância ou admitância (incluindo timpanograma, medição de compliance, volume do conduto externo, reflexos acústicos ipsi e contra-laterais)', 15);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Electroneuronomiografia de superfície com auxílio de equipamento computorizado E.No.M.G. (três avaliações sucessivas)', 40);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fonocardiograma com registo simultâneo duma derivação electrocardiográfica e dum mecanograma de referência', 9);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Apexocardiograma', 7);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Electrocardiograma simples de 12 derivações com interpretação e relatório', 6);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Electrocardiograma simples de 12 derivações com interpretação e relatório, no domicílio', 9);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Prova de esforço máxima ou submáxima em tapete rolante ou cicloergómetro com monitorização electrocardiográfica contínua, sob supervisão médica, com interpretação e relatório', 40);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Vectocardiograma, com ou sem ECG, com interpretação e relatório', 10);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Monitorização electrocardiográfica contínua prolongada pelo método de Holter com gravação contínua, "scanning" por sobreposição ou impressão total miniaturizada, e análise automática, efectuada sob supervisão médica, com interpretação e relatório', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Monitorização electrocardiográfica contínua prolongada por método de Holter, com análise de dados em tempo real, gravação não contínua e registo intermitente, efectuada sob supervisão médica, com interpretação e relatório', 12);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Monitorização electrocardiográfica prolongada com registo de eventos activado pelo doente com memorização pré e pós-sintomática, efectuada sob supervisão médica, com intrepretação', 10);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Registo electrocardiográfico de alta resolução, com ou sem ECG de 12 derivações', 9);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Registo ambulatório prolongado (24h ou mais) da pressão arterial incluindo gravação, análise por "scanning", interpretação e relatório', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Teste baroreflexo da função cardiovascular com mesa basculante ("tilt table"), com ou sem intervenção farmacológica', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ecocardiografia em tempo real (bidimensional), com registo de imagem, com ou sem registo em modo-M', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, associada a ecografia Doppler, pulsada ou contínua, com análise espectral', 40);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ecocardiografia transesofágica em tempo real (bidimensional), com ou sem registo em modo-M, com inclusão de posicionamento da sonda, aquisição de imagem, interpretação e relatório', 80);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ecocardiog. de sobrecarga em tempo real (bidim.), c/ou sem registo em modo-M, durante repouso e prova Cardiov., c/teste máx. ou submáx. em tap. rolante, cicloergométrico e/ou sobrec. farmac., incluindo monitorização electrocardiog., c/interpret. e relat.', 80);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ecocardiografia intra-operatória em tempo real (bidimensional), com registo de imagem, com ou sem registo em modo-M, com estudo Doppler, pulsado ou contínuo, com análise espectral, estudo completo, com interpretação e relatório', 80);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fonocardiograma com registo simultâneo duma derivação electrocardiográfica e dum mecanograma de referência', 14);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Apexocardiograma', 10);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Electrocardiograma simples de 12 derivações com interpretação e relatório', 8);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Electrocardiograma simples de 12 derivações com interpretação e relatório, no domicílio', 14);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Prova de esforço máxima ou submáxima em tapete rolante ou cicloergómetro com monitorização electrocardiográfica contínua, sob supervisão médica, com interpretação e relatório', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Vectocardiograma, com ou sem ECG, com interpretação e relatório', 15);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Monitorização electrocardiográfica contínua prolongada pelo método de Holter com gravação contínua, "scanning" por sobreposição ou impressão total miniaturizada, e análise automática, efectuada sob supervisão médica, com interpretação e relatório', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Monitorização electrocardiográfica contínua prolongada por método de Holter, com análise de dados em tempo real, gravação não contínua e registo intermitente, efectuada sob supervisão médica, com', 16);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Monitorização electrocardiográfica prolongada com registo de eventos activado pelo doente com memorização pré e pós sintomática, efectuada sob supervisão médica, com intrepretação', 15);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Registo electrocardiográfico de alta resolução, com ou sem ECG de 12 derivações', 12);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Registo ambulatório prolongado (24h ou mais) da pressão arterial incluindo gravação, análise por "scanning", interpretação e relatório', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Teste baroreflexo da função cardiovascular com mesa basculante ("tilt table"), com ou sem intervenção farmacológica', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ecocardiografia em tempo real (bidimensional), com registo de imagem, com ou sem registo em modo-M', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, associada a ecografia Doppler, pulsada ou contínua, com análise espectral', 50);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ecografia em tempo real (bidimensional), com ou sem registo em modo-M, transesofágica, com inclusão de posicionamento da sonda, aquisição de imagem, interpretação e relatório', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ecocardiog. Em tempo real (bidim.), c/ou sem registo em modo-M, durante repouso e prova sobrec. Cardiov., c/teste máx. ou submáximo em tap. Rolante, cicloergométrico e/ou sobrec. Farmac., incluindo monitorização electrocardiográfica, c/interpret. E relat.', 50);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ecocardiografia em tempo real (bidimensional), com registo de imagem, com ou sem registo em modo-M, com estudo Doppler, pulsado ou contínuo, com análise espectral, intra-operatória, estudo completo, com interpretação e relatório', 45);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Implantação e posicionamento de catéter de balão por cateterismo direito para monitorização (Swan-Ganz)', 50);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco direito com angiografia (ventrículo direito ou artéria pulmonar)', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com ventrículografia esquerda, coronariografia selectiva', 115);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com ventrículografia esquerda, coronariografia selectiva e aortografia', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com ventrículografia esquerda, coronariografia selectiva, aortografia e cateterísmo direito', 145);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com ventrículografia esquerda, coronariografia selectiva, aortografia, cateterismo direito e visualização de "bypasses" aorto-coronários', 155);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com visualização de "bypasses" aorto-coronários', 110);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Prova de provocação de espasmo coronário (ergonovina)', 75);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Estudos de medição de débito cardíaco com corantes indicadores ou por termodiluição, incluindo cateterismo arterial ou venoso', 75);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Registo electrocardiográfico transesofágico com estimulação eléctrica ("pacing")', 18);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Registo do electrograma intra-auricular, do feixe de His, do ventrículo direito ou do ventrículo esquerdo', 25);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Mapeamento intraventricular e/ou intrta-auricular de focos de taquicardia com registo multifocal, para indentificação da origem da taquicárdia', 35);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Estudo electrofisiológico completo com "pacing" e/ou registo de auricula direita, ventrículo direito e feixe de His, com indução de arritmias, incluindo implantação e reposicionamento de múltiplos electro-catéteres', 130);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, com indução de arritmias', 175);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, com regiso de aurícula esquerda, seio coronário ou ventrículo esquerdo com ou sem "pacing"', 200);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Estimulação programada e "pacing" após infusão intravenosa de fármacos', 70);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Estudo electrofisiológico de "follow-up" com "pacing" e registo para teste de eficácia de terapêutica, incluindo indução ou tentativa de indução de arritmia', 70);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com coronariografia selectiva e angioscopia coronária', 130);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com coronariografia selectiva e ultrassonografia intracoronária', 130);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Implantação e posicionamento de catéter de balão por cateterismo direito para monitorização (Swan-Ganz)', 75);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco direito com angiografia (ventrículo direito ou artéria pulmonar)', 120);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com ventrículografia esquerda, coronariografia selectiva', 220);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com ventrículografia esquerda, coronariografia selectiva e aortografia', 130);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com ventrículografia esquerda, coronariografia selectiva, aortografia e cateterísmo direito', 300);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com ventrículografia esquerda, coronariografia selectiva, aortografia, cateterismo direito e visualização de "bypasses" aorto-coronários', 300);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com visualização de "bypasses" aorto-coronários', 225);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Estudos de medição de débito cardíaco com corantes indicadores ou por termo-diluição, incluindo cateterismo arterial ou venoso', 125);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, medições subsequentes', 15);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Registo electrocardiográfico transesofágico', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Registo electrocardiográfico transesofágico com estimulação eléctrica ("pacing")', 40);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Registo do electrograma intra-auricular, do feixe de His, do ventrículo direito ou do ventrículo esquerdo', 50);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Mapeamento intraventricular e/ou intra-auricular de focos de taquicardia com registo multifocal, para identificação da origem da taquicárdia', 75);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Estudo electrofisiológico completo com "pacing" e/ou registo de auricula direita, ventrículo direito e feixe de His, com indução de arritmias, incluindo implantação e reposicionamento de múltiplos electro-catéteres', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, com indução de arritmias', 175);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, com registo de aurícula esquerda, seio coronário ou ventrículo esquerdo com ou sem "pacing"', 180);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com coronariografia selectiva e angioscopia coronária', 250);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo cardíaco esquerdo com coronariografia selectiva e ultrassonografia intracoronária', 250);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Colocação percutânea de dispositivo de assistência cardio-circulatória, v.g. balão intra-aórtico para contrapulsação', 105);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, remoção', 55);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, controle', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Trombólise coronária por infusão intracoronária, incluindo coronariografia selectiva', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Aterectomia percutânea trasluminal direccional coronária de Simpson de um vaso', 210);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Electrofisiologia de intervenção terapêutica, com ablacção de vias anómalas, por energia de radiofrequência', 235);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Electrofisiologia de intervenção terapêutica, com ablacção ou modulação da junção auriculo-ventricular, por energia de radiofrequência', 200);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Electrofisiologia de intervenção terapêutcia, com ablacção de focos de taquidisritmia ventricular, por energia de radiofrequência', 250);
INSERT INTO ProcedureType VALUES (DEFAULT, '"Pacing" temporário percutâneo', 45);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Implantação de pacemaker permanente com eléctrodo transvenoso, auricular', 180);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Implantação de pacemaker permanente com eléctrodo transvenoso, ventricular', 180);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Implantação de pacemaker permanente com eléctrodo transvenoso, de dupla câmara', 195);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Substituição de gerador "pacemaker", de uma ou duas câmaras', 85);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Passagem de sistema "pacemaker" de câmara única a dupla câmara, (incluindo explantação do gerador anterior, teste do eléctrodo existente e implantação de novo eléctrodo e de novo gerador)', 185);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Revisão cirúrgica de sistema "pacemaker", sem substituição de gerador (incluindo substituição, reposicionamento ou reparação de eléctrodos transvenosos permanentes), cinco ou mais dias após implantação inicial)', 70);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Remoção de sistema "pacemaker"', 70);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Controlo electrónico do sistema "pacemaker" permanente de uma câmara, sem programação', 4.5);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, com programação', 6);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Controlo electrónico de sistema "pacemaker" permanente de dupla câmara, sem programação', 6);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, com programação', 8);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Implantação de cardioversor-desfibrilhador automático com eléctrodos (sensores e cardioversores-desfibrilhadores) transvenosos', 360);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Revisão, reposicionamento ou explantação de eléctrodos (sensores e cardioversores-desfibrilhadores) transvenosos de sistema cardioversor-desfibrilhador', 315);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Controlo electrónico de cardioversor-desfibrilhador automático, sem programação', 5);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, com programação', 8);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação electrofisiológica de cardioversor desfibrilhador automático', 75);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Pericardiocentese', 20);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Colocação percutânea de dispositivo de assistência cardio-circulatória, v.g. balão intra-aórtico para contrapulsação', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, remoção', 55);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, controle', 30);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Electrofisiologia de intervenção terapêutica, com ablacção de vias anómalas, por energia de radiofrequência', 320);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Electrofisiologia de intervenção terapêutica, com ablacção ou modulação da junção auriculo-ventricular, por energia de radiofrequência', 320);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Electrofisiologia de intervenção terapêutcia, com ablacção de focos de taquidisritmia ventricular, por energia de radiofrequência', 320);
INSERT INTO ProcedureType VALUES (DEFAULT, '"Pacing" temporário percutâneo', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Implantação de "pacemaker" permanente com eléctrodo transvenoso, auricular', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Implantação de "pacemaker" permanente com eléctrodo transvenoso, ventricular', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Implantação de "pacemaker" permanente com eléctrodos transvenosos, de dupla câmara', 270);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Substituição de gerador "pacemaker", de uma ou duas câmaras', 100);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Passagem de sistema "pacemaker" de câmara única a dupla câmara, (incluindo explantação do gerador anterior, teste do eléctrodo existente e implantação de novo eléctrodo e de novo gerador)', 185);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Revisão cirúrgica de sistema "pacemaker", sem substituição de gerador (incluindo substituição, reposicionamento ou reparação de eléctrodos transvenosos permanentes), cinco ou mais dias após implantação inicial)', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Mecânica ventilatória simples (estudo de volumes, incluindo o volume residual+débitos+resistência das vias aéreas)', 22);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Aspirado brônquico, para bacteriologia, micologia, parasitologia e citologia', 5);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Escovado brônquico duplamente protegido para pesquisa de germens (aeróbios e anaeróbios) e fungos', 5);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento de condilomas vulvares (cauterização química, eléctrica ou criocoagulação)', 15);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Iniciação e/ou supervisão de monitorização fetal interna durante o trabalho de parto', 40);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Injecção intra-amniótica (amniocentese) de solução hipertónica e/ou prostaglandinas para indução do trabalho de parto', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Injecção intra-uterina extra amniótica de solução hipertónica e/ou prostaglandinas para indução do trabalho', 10);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Monitorização fetal externa, com protocolos e extractos dos cardiotocogramas (fora ou durante o trabalho de parto de parto) . Teste de reatividade fetal', 8);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Crioterapia, com azoto liquido, de lesões malignas, excepto face e região frontal', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Crioterapia, com azoto liquido, de lesões malignas da face e região frontal', 40);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame urodinâmico do aparelho urinário alto-estudo de perfusão renal (exclui nefrostomia)', 25);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Endoscopia flexivel (a acrescentar ao valor do custo real da endoscopia do orgão)', 50);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Escleroterapia ambulatória de varizes do membro inferior (por sessão e por membro)', 15);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Aplicação de aparelho de compressão permanente (bota una, cola de zinco, kompress, etc.)', 10);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Compressão pneumática sequencial', 5);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Drenagem linfática de membro por correntes farádicas em sincronismo cardíaco, com massagem', 5);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Biópsia sinovial fechada de outras articulações sem intensificador de imagem', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Biópsia sinovial fechada de outras articulações com intensificador de imagem', 35);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Sinoviortese com radioisótopos Renium 186 (com intensificador de imagem)', 30);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artroscopia terapêutica simples (extração de corpos livres, desbridamentos, secções, etc)', 90);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão de pequenos tumores benignos ou quistos subcutâneos excepto região frontal e face', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão de lesões benignas da região frontal da face e mão, passíveis de encerramento directo', 40);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão de tumor profundo', 100);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão de lesões benignas ou malignas só passíveis de encerramento com plastia complexa, na região frontal, face e mão', 200);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão de lesões benignas ou malignas só passíveis de encerramento com plastia complexa, excepto região frontal, face e mão', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão de cicatrizes da face, pescoço ou mão e plastia por retalhos locais (Z, W, LLL, etc)', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Sutura de ferida da face e região frontal até 5 cm (adultos) e 2,5 cm (crianças)', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Sutura de ferida da face e região frontal maior do que 5 cm (adultos) e 2,5 cm(crianças)', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Sutura de ferida cutânea até 5 cm (adultos) ou 2,5 cm (crianças) excepto face e região frontal', 15);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Sutura de ferida cutânea maior do que 5 cm (adultos) ou 2,5 cm (crianças), excepto face e região frontal', 20);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão de cicatrizes de pregas de flexão e plastia por retalhos locais', 75);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão de cicatrizes, excepto face, pescoço ou mão e sutura directa', 50);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão de cicatrizes, excepto face, pescoço ou mão e plastia por retalhos locais', 60);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Desbridamento cirúrgico de queimadura até 3% excepto face, pescoço e mão', 20);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia da calvície, enxertos pilosos, com microcirurgia (cada sessão)', 200);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ritidectomia das pálpebras (por pálpebra) com ressecção das bolsas adiposas', 60);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Abdominoplastia, com transposição do umbigo e reparação músculo-aponevrótica', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Remodelação corporal por inclusão de material biológico conservado, por unidade estética', 50);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Enxerto dermoepidérmico até 10 cm2 ou de 0,5% da superfície corporal das crianças, excepto face, boca, pescoço, genitais ou mão', 40);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Enxerto dermoepidérmico até 100 cm2 ou de 1% da superfície corporal das crianças excepto face, boca, pescoço, genitais ou mão', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Enxerto dermoepidérmico maior que 100 cm2 ou de 1% da superfície corporal das crianças', 100);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Enxerto dermoepidérmico maior que 100 cm2 ou de 1% da superfície corporal das crianças por cada área de 100 cm2 a mais', 50);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Enxertos em rede', 80);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Enxerto dermoepidérmico até 100 cm2 ou de 1% da superfície corporal das crianças, face, boca, pescoço, genitais ou mão', 100);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Enxerto dermoepidérmico maior que 100 cm2 ou de 1% da superfície corporal das crianças na face, boca, genitais ou mão', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Enxerto de clivagem, ou de pele total na região frontal, face, boca, pescoço, axila, genitais, mãos e pés até 20', 100);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Enxerto de clivagem, ou de pele total na região frontal, face, boca, pescoço, axila, genitais, mãos e pés maior que', 140);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Enxertos adiposos ou dermo-adiposos fascia, cartilagem, ósseo, periósteo', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Retalhos de tecidos adjacentes na região frontal face, boca, pescoço, axila, genitais mãos, pés até 10', 140);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Retalhos de tecidos adjacentes na região frontal, face, boca, pescoço, axila, genitais, mãos, pés, maior que 10', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Retalhos cutâneos, miocutâneos ou musculares com pedículo vascular ou vasculo nervoso identificado', 200);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Retalhos de tecidos adjacentes no couro cabeludo, tronco e membros (excepto mãos e pés) menores que', 100);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Retalhos de tecidos adjacentes no couro cabeludo, tronco e membros (excepto mãos e pés) de 10cm2 a', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Retalhos de tecidos adjacentes no couro cabeludo, tronco e membros (excepto mãos e pés) maior que', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Retalhos miocutâneos, musculares, ou fasciocutâneos sem pedículo vascular indentificado', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Retalhos cutâneos, miocutâneos, fasciocutâneos ou musculares, com pedículo vascular ou vasculo nervoso identificado', 200);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Expansão tissular para correcção de anomalias várias, por cada expansor e cada tempo operatório', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reconstrução mamária pós mastectomia ou agenesia com utilização de expansor', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão de lesão da mama (com ou sem marcação) e com esvaziamento axilar', 140);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Esvasiamento axilar como 2º. tempo de cirurgia conservadora do carcinoma da mama (cirurgia diferida)', 140);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reimplantes do braço ou antebraço, completos', 500);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reimplantes do braço e antebraço incompletos (com pedículo de tecidos moles)', 450);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento de fractura do complexo nasoetmoide, incluindo reparação dos ligamentos centrais epicantais', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento de fractura do maxilar superior, com fixação interna ou externa', 140);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento de fractura do pavimento da òrbita, tipo "blow-out" com endoprotese de "Silastic"', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento de fractura do pavimento da órbita, tipo "blow-out", com enxerto ósseo', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento ortopédico da fractura mandíbular por fixação intermaxilar', 110);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento cirúrgico e osteossíntese da fractura mandíbular (1 osteossíntese)', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento cirúrgico com osteossínteses múltiplas de fracturas mandíbulares', 200);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento cirúrgico de fractura mandíbular por osteossíntese e bloqueio intermaxilar', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia estética para estabilização funcional das comissuras (suspensões) mioneurotomias selectivas', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna cervical, via transoral, sem artrodese ou osteossíntese', 180);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna cervical, via transoral, com artrodese ou osteossíntese', 220);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna cervical, via anterior ou anterolateral sem artrodese', 180);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna cervical, via anterior ou anterolateral com artrodese', 220);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna cervical, via posterior sem artrodese', 160);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna cervical, via posterior com artrodese', 180);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna dorsal, via anterior', 220);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna dorsal, via anterior com artrodese', 270);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna dorsal, via posterior sem artrodese', 160);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna dorsal, via posterior com artrodese', 180);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna lombar, via anterior sem artrodese', 160);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna lombar, via anterior com artrodese', 240);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna lombar, via posterior sem artrodese', 160);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fracturas ou fractura luxação da coluna lombar, via posterior com artrodese', 180);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento de fractura cominutiva ou fractura-luxação da extremidade proximal do úmero', 160);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Osteossíntese da diáfise umeral (com ou sem exploração do nervo radial)', 140);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção óssea segmentar de tumores invasivos com reconstituição por prótese ou enxerto homólogo', 280);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artrotomia ou artroscopia com tratamento de lesões articulares circunscritas', 120);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Sutura do tendão ou tendões do bicípite ou de um longo músculo do ombro', 75);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Correcção das sequelas da paralisia braquial no cotovelo (dinamização)', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Osteossíntese percutânea ou cruenta da fractura supracondiliana do úmero na criança', 130);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção de pequenos tumores benignos (exostoses inclusive, 1 ou 2)', 90);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção de tumores sinoviais ou osteoperiósticos extensos no cotovelo', 180);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção óssea segmentar de tumores invasivos com reconstituição por prótese ou enxerto homólogo no cotovelo', 220);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artrotomia ou artroscopia com tratamento de lesões articulares circunscritas', 110);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Transposição dos tendões por paralisia dos extensores (paralisia do nervo radial)', 120);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção de pequenas lesões ou tumores ósseos circunscritos com preenchimento ósseo', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção parcial do escafóide cárpico ou semilunar com artroplastia de interposição', 140);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reconstrução do polegar em vários tempos com plastia abdominal ou torácica e enxerto ósseo', 230);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reconstrução do polegar em vários tempos com plastia abdominal ou torácica, enxerto ósseo e pedículo neurovascular de Littler', 300);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fasciotomia total com enxerto cutâneo por retracção da aponevrose palmar', 160);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Correcção da paralisia dos músculos intrinsecos por lesão do nervo cubital', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Correcção da paralisia dos músculos intrinsecos por lesão do nervo mediano', 160);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Sutura ou tenólise dos tendões extensores dos dedos da mão: mais de um tendão', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fasciectomia parcial com enxerto cutâneo por retracção da aponevrose palmar', 100);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fasciectomia total com enxerto cutâneo por retracção da aponevrose palmar', 160);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Correcção de sequelas reumatismais da mão (artroplastia) por cada articulação', 90);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artroplastia por cada articulação', 70);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Correcção da sindroma do canal cárpico e outras sindromes compressivos do membro superior', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Biópsia a "céu aberto" ou ressecção de pequenos tumores benignos (exostoses inclusive, 1 ou 2)', 90);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção de tumores osteoperiósticos extensos', 200);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção óssea segmentar de tumores invasivos com reconstituição por prótese ou enxerto homólogo', 300);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artroplastia total em revisão de prótese total, de artrodese, de LCA ou após Girdlestone', 260);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artrotomia ou artroscopia com tratamento de lesões articulares circunscritas', 140);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Plastia músculo-aponevrótica por paralisia dos glúteos em 1 ou vários tempos', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Osteossíntese da fractura bituberositária ou da fractura cominutiva da extremidade proximal', 130);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reconstrução focal da superfície articular com enxerto osteocartilagíneo', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artroplastia total por artrose ou revisão de prótese unicompartimental', 220);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia pararotuliana convencional ou artroscópica (suturas, plicaduras, secções)', 90);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Rotura do tendão quadricipital, rotuliano, ou fractura-avulsão tuberositária', 90);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artrotomia ou artroscopia com tratamento de lesões articulares circunscritas', 130);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento da pseudoartrose da diáfise da tíbia após fractura (com ou sem enxerto ósseo)', 160);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção óssea segmentar de tumores invasivos com reconstrução por prótese ou enxerto', 280);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Osteotomia diafisária do peróneo (isolada, não adjuvante de osteotomia da tíbia)', 90);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artrotomia ou artroscopia com tratamento de lesões articulares circunscritas', 110);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artrotomia por osteotomia maleolar com tratamento de lesões articulares', 110);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Alongamento a "céu aberto" do tendão de Aquiles ou tratamento da tendinite', 90);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento do síndrome do canal társico e das neuropatias estenosantes dos ramos do nervo tíbial posterior', 110);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção artroplástica de uma metatarsofalângica, excepto a 1ª. Ou de uma ou duas interfalângicas', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção artroplástica de duas metatarsifalângicas, excepto a 1ª. Ou de várias interfalângicas', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção artroplástica múltipla para realinhamento metatarsofalângico', 110);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artrorrisis subastragaliana no pé plano infantil (via interna e externa)', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artrorrisis subastragaliana no pé plano infantil por "calcâneo stop" bilateral', 120);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Osteotomia diafisária do 1º. metatarsiano (tipo Qp. Wilson ou de Helal)', 80);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Osteotomia distal do 1º. Matatarsiano (tipo Op. de Mitchell ou de "chevron")', 110);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Uma ou duas artroplastias de interposição protésica metarsofalângica, excepto no 1º. raio, ou interfalângicas', 100);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Três ou mais artroplastias de interposição protésica metatarso falângicas, excepto no 1º. raio, ou interfalângicas', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Uma ou duas artroplastias de ressecção ou artrodeses interfalângicas, excepto no 1º. raio', 50);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Três ou mais artroplastias de ressecção ou artrodeses interfalângicas, excepto no 1º. raio', 70);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Transferência de tendão do tibial anterior, peroniais ou do longo extensor comum', 110);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Transferência do longo extensor ao colo do 1º. metatarsiano (Op. de Jones)', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento de quisto, ou outros defeitos ósseos circunscritos, por esvasiamento e preenchimento com', 140);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento de quisto, ou outros defeitos ósseos circunscritos, por esvaziamento e preenchimento com', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento de quisto, ou outros defeitos ósseos circunscritos, por esvaziamento e preenchimento com', 90);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Alongamento ósseo com fixador externo (Illizarov, Wagner, etc.) (tratamento total)', 250);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento cirúrgico das malformações congénitas da laringe (bridas, quistos, palmuras)', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia de implantação epicárdica de sistemas de pacemaker/disfibrilhação automática', 200);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Substituição da aorta ascendente e válvula aórtica c/tubo valvulado ou homoenxerto (op. de Bentall)', 700);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia do arco aórtico', 700);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Outras cirurgias para correcção total de cardiopatias congénitas complexas', 700);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artérias ilíacas: unilateral sem desobstrução aórtica, via abdominal ou extraperitoneal', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artérias ilíacas: unilateral sem desobstrução aórtica, via inguinal (anéis)', 120);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artérias femoral superficial ou poplitea ou tronco tibioperoneal segmentar', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artérias femoral superficial ou poplitea ou tronco tibioperoneal, extensa(Edwards)', 180);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Revascularização múltipla de troncos supra-aorticos a partir da aorta', 350);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Arco aortico, com protecção por C.E.C. ou pontes (incluindo toda a equipa médica)', 800);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Aorta descendente torácica e/ou abdominal; incluindo ramos viscerais, sem C.E.C. (aorta toracoabdominal)', 500);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Aorta descendente, torácica e abdominal, incluindo ramos viscerais, com C.E.C. (incluindo a equipa médica)', 600);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reparação das lesões da dissecção da aorta, tipo distal na porta de entrada', 500);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Artérias carótidas, libertação e fixação para tratamento de angulações', 130);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Interrupção da veia cava inferior por laqueação, plicatura, ou agrafe', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem + excisão da veia safena interna ou externa com ou sem laqueação de comunicantes com ou sem excisão de segmentos venosos', 160);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem em ambas as veias de um membro (veia safena interna e externa)', 190);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão da veia safena interna ou externa com ou sem laqueação de comunicantes, com ou sem laqueação de segmentos venosos intermédios, sem laqueação de crossas de safena interna ou externa', 130);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Laqueação de comunicantes com ou sem excisão de segmentos venosos', 75);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Laqueação da crossa da veia safena interna ou externa + laqueação de comunicantes com ou sem excisão de segmentos', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Laqueação das crossas das veias safena interna e externa + laqueação de comunicantes com ou sem excisão venosas', 190);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Revisão de laqueação de crossa de veia safena interna ou externa em recidiva de varizes', 90);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Via abdominal, transsecção esofágica ou plicatura com anastomose(instrumento mecânico)', 200);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Implantação de fios ou outro material para incrementar a drenagem linfática', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ponte arterio-arterial ou arterio-venosa (não inclui o custo de op. acessória ou de prótese)', 160);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia das complicações dos acessos vasculares com continuidade do acesso', 120);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exodontia complicada ou de siso incluso, não complicada (sem osteotomia)', 20);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exérese de ranulas simples ou outros pequenos tumores dos tecidos moles da cavidade oral, com anestesia local', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exérese de ranulas simples ou outros pequenos tumores dos tecidos moles da cavidade oral, com anestesia geral', 50);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Redução e contenção do dente luxado por trauma com regularização do bordo alveolar (por quadrante)', 30);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Impressão em elastrómero de síntese ou hidrocoloide reversível (com moldeira ajustada ou equivalente)', 45);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Impressão funcional usando base ajustada, material termoplástico e outro', 45);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Registo da relação intermaxilar usando cera em base estabilizada numa arcada', 10);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Preparação gengival com vista à tomada de impressão imediata: retracção gengival, cirurgia, hemostase, remoção de mucosidade e coágulos (em cada elemento)', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Prova ou inserção de cada elemento protético (por sessão)', 15);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Elaboração de prótese provisória em resina para protecção de côto preparado', 30);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Montagem de modelos em articulador semifuncional sem registos individuais mas com arco facial (valores médicos) e análise', 80);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Equilíbrio oclusal clínico (por sessão)', 50);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Montagem de modelos em articulador semifuncional com uso de arco facial ajustado e de arco localizador cinemático, e com registos individuais', 300);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Equilíbrio oclusal do paciente de acordo com os valores obtidos no articulador', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento cirúrgico de fenda completa unilateral do paladar primário', 140);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento cirúrgico de fenda bilateral (cada lado) do paladar primário', 110);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento cirúrgico de fenda do paladar primário tempos complementares', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Incisão e drenagem de quistos, abcessos intra-orais ou hematomas da língua ou pavimento da boca-superficiais', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Incisão e drenagem de quistos, abcessos intra-orais ou hematomas da língua ou pavimento da boca-profundos', 25);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Incisão e drenagem extra-oral de abcesso, quisto e/ou hematoma do pavimento da boca ou sublingual', 30);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Glossectomia com ressecção do pavimento da boca e mandíbula com esvaziamento cervical', 320);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reparação de laceração até 2 cm do pavimento ou dos 2/3 anteriores da língua', 20);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Estafilorrafia por fenda palatina incompleta ou estafilorrafia simples', 125);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Revisão de anastomose gastroduodenal ou gastrojejunal com reconstrução', 250);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão de pequenas lesões não requerendo anastomose ou exteriorização', 120);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção de tumor benigno por via transagrada e/ou transcoccígea (tipo Kraske)', 180);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção de tumor maligno por via transagrada e/ou transcoccigea (tipo Kraske)', 250);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterização cirúrgica da artéria hepática para tratamento complementar', 220);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Laparotomia para drenagem de abcesso peritoneal ou retroperitoneal (excepto apêndice)', 120);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento de hérnia estrangulada, a acrescentar ao valor da respectiva localização', 25);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento de hérnia com ressecção intestinal, a acrescentar ao valor da respectiva localização', 45);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento de perda de substância da parede abdominal-enxertos (fascia lata, dérmico, rede, etc.)', 160);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Pielocalico(lito)tomia ou pielonefro(lito)tomia por litíase coraliforme ou précoraliforme', 200);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia endoscópica do segmento pielo-ureteral (SPU), bacinete ou cálices com ureterorrenoscópio', 160);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Nefro(lito)extracção percutânea com litotritor ultra-sónico, electro-hidráulico ou laser', 200);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Litotrícia extracorporal por ondas de choque (sessões complementares - dentro de um periodo de 3 meses)', 130);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ureterostomia cutânea indirecta transileal (ureteroileostomia cutânea-operação de Bricker)', 280);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ureterostomia cutânea indirecta transcólica (ureterocolostomia cutânea)', 280);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ureterocistoneostomia (Reimplantação ureterovesical) ou operação anti-refluxo sem ureteroneocistostomia', 160);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem bilateral', 200);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cateterismo endoscópico ureteral terapêutico unilateral (incluí dilatação endoscópica sem visão e inclui', 40);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ureterolitoextracção sob visão com URC com litotritor ultra-sónico, electro-hidráulico ou laser', 140);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Uretero(lito)extracção percutânea com litotritor ultra-sónico, electro-hidráulico ou laser', 160);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Encerramento de fístula vesicocutânea (inclui encerramento de cistosmia)', 110);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Enterocitoplastia de alargamento (qualquer tipo de segmento intestinal)', 280);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Litotrícia endoscópica vesical com litotritor ultra-sónico, electro-hidráulico ou laser', 140);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Alargamento endoscópico do colo vesical feminino com incisão de colo vesical', 50);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Litotrícia extracorporal por ondas de choque', 140);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem sessão complementar', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Colocação de prótese para tratamento de incontinência urinária (esfincter artificial)', 180);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reeducação perineo-esfincteriana, por incontinência urinária, biofeedback ou electroestimulação, por sessão', 10);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia da incontinência urinária do homem (exclui próteses e cirurgia endoscópica)', 180);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Alargamento endoscópico da loca prostática com incisão ou ressecção de fibrose da loca', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Alargamento endoscópico de colo vesical masculino com incisão ou ressecção de colo vesical', 70);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Colocação endoscópica de prótese de alargamento de colo vesical de uretra prostática', 70);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tratamento endoscópico da incontinência urinária masculina', 140);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Colocação endoscópica de prótese uretral expansível reepitelizável (exclui o custo da prótese)', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Colocação de prótese para tratamento de incontinência urinária (esfincter artificial)', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Hipertermia prostática (Independentemente do número de sessões)', 80);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Termoterapia prostática transuretral (independentemente do número de sessões - não incluí sonda aplicadora)', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia do hipospadias e da uretra curta congénita proximal num só tempo', 220);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Colocação endoscópica de prótese uretral expansível reepitelizável (exclui o custo da prótese)', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia de angulação e mal-rotação peniana e da doença de Peyronie com operação de Nesbit', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Punção - esvaziamento - lavagem dos corpos cavernosos para tratamento do priapismo', 30);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia do varicocele com laqueação-ressecção múltipla de veias varicosas', 90);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia da obstrução espermática com anastomose epididimo-deferencial (epididimo-vasostomia)', 160);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão de espermatocele ou quisto para testicular epididimário ou do cordão espermático', 75);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Colpoperineorrafia por rasgadura incompleta do perineo e vagina (não obstétrica)', 80);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Colpoperrineorrafia com sutura do recto, esfíncter anal, por rasgadura completa do perineo (não obstétrica)', 120);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Vesicouretropexia anterior ou uretropexia, via abdominal (tipo Marshall-Marchetti)', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Suspensão uretral (fáscia ou sintético) por incontinência urinária ao esforço (tipo Stockel)', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Intervenção cirúrgica para neovagina, em tempo único, simples com ou sem enxerto cutâneo', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Intervenção cirúrgica para neovagina em tempos múltiplos, ou com plastia complexa (retalhos loco-regionais)', 250);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Histerectomia radical com linfadenectomia pélvica bilateral (tipo Wertheim-Meigs)', 300);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Laparotomia exploradora com biópsias para estadiamento por neoplasia ginecológica', 120);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Citoredução do carcinoma do ovário em estadios superiores ou igual ao IIB', 300);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reparação de episiotomia e/ou rasgadura incompleta do períneo e/ou rasgadura da vagina, simples', 25);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Extensa', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Colpoperineorrafia e reparação do esfíncter anal por rasgadura completa do perineo consecutiva a parto', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Parto normal (com ou sem episiotomia) compreendida anestesia feita pelo próprio médico', 65);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Parto gemelar normal por cada gémeo', 65);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Parto distócio, compreendidas todas as intervenções, tais como: fórceps, ventosa, versão grande, extracção pélvica, dequitadura artificial, episeorrafia, desencadeamento médico ou instrumental do trabalho', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tiroidectomia total ou sub-total com esvaziamento cervical conservador', 300);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Craniectomia ou craniotomia para remoção de corpo estranho no encéfalo (bala, etc)', 250);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Laqueação da carótida interna intracraniana para tratamento de aneurismas e fistulas carótido-cavernosas', 250);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exenteração da órbita com remoção de partes ósseas ou com transplante muscular', 220);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Remoção de implante ocular', 50);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Queratectomia lamelar, parcial, excepto pterígio (ex. quisto dermóide)', 70);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Excisão ou transposição de pterígio recidivado com queratoplastia parcial', 240);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Queratoplastia lamelar na afaquia (inclui preparação do material de enxerto)', 240);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Queratoplastia penetrante e queratoprótese (inclui preparação do material de enxerto)', 280);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Paracentese da câmara anterior para remoção ou aspiração de humor aquoso, hipópion ou hifema', 50);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Paracentese da câmara anterior para remoção de humor vítreo e/ou libertação de sinéquias e/ou discisão da hialoideia anterior, com ou sem injecção de ar', 90);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Introdução de lente intra-ocular para correcção da ametropia em olho fáquico', 200);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Lise de sinéquias do segmento anterior, incluindo goniosinéquias, por incisão com ou sem injecção de ar/líquido (técnica isolada)', 70);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Lise de sinéquias anteriores ou de sinéquias posteriores ou de aderências corneovítreas com ou sem injecção de ar/líquido', 55);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fistulização da esclerótica no glaucoma, trabeculectomia ab externo com encravamento escleral', 190);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fistulização esclerótica no glaucoma com colocação de tubo de Molteno ou similar', 200);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Laserterapia (coreoplastia, gonioplastia e iridotomia (1 ou mais sessões))', 65);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fotocoagulação dos processos ciliares (1 ou mais sessões)', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Destruição de lesões quísticas ou outras da Íris e/ou do corpo ciliar por meios não cruentos', 150);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Remoção de catarata secundária com ou sem iridectomia (iridocapsulectomia ou iridocapsulotomia)', 180);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Aspiração de material lenticular na sequência ou não de facofragmentação mecânica', 180);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Extracção intracapsular ou extracapsular na presença de ampola de filtração', 200);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Aplicação de qualquer lente intraocular simultaneamente à extracção de catarata', 250);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Aspiração de vítreo ou de liquido sub-retiniano ou coroideu (esclerotomia posterior)', 120);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Liga de bandas de vítreo, adesões da interface do vítreo, bainhas, membranas ou opacidades por cirurgia laser', 85);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Vitrectomia via pars plana associada à extracção de cristalino com introdução de lente intraocular', 360);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Vitrectomia mecânica complicada via pars plana, com tamponamento interno com ou sem extracção de corpo estranho intraocular, com ou sem cirurgia de cristalino', 360);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia de descolamento de retina com vitrectomia associada a tamponamento', 320);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia de descolamento de retina com vitrectomia a céu aberto e tamponamento interno', 360);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia de descolamento de retina com vitrectomia, tamponamento interno e extracção de cristalino', 360);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia de descolamento de retina com vitrectomia e segmentação, delaminação e corte de membranas de', 400);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Miopexia retroequatorial de um músculo associado a enfraquecimento/reforço de dois músculos', 190);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Miopexia retroequatorial de um músculo associada a enfraquecimento/reforço de três músculos', 210);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Miopexia retroequatorial de dois músculos associada a enfraquecimento/reforço de um músculo', 210);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Miopexia retroequatorial de dois músculos associada a enfraquecimento/reforço de dois músculos', 225);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia ajustável sobre um músculo (Incluí o ajuste a efectuar posteriormente)', 165);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia ajustável sobre dois músculos (incluí o ajuste a efectuar posterirmente)', 190);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia ajustável de um músculo associada a enfraquecimento/reforço/miopexia de um músculo (incluí ajuste a efectuar posteriormente)', 200);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Cirurgia ajustável de um músculo associada a enfraquecimento/reforço/miopexia de dois músculos (incluí ajuste a efectuar posteriormente)', 240);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Transposição muscular de um músculo no estrabismo paralítico', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Transposição        muscular         de     um      músculo       no      estrabismo        paralítico        associada a enfraquecimento/reforço/miopexia de um músculo)', 145);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Transposição       muscular         de      um      músculo      no      estrabismo         paralítico,       associada a enfraquecimento/reforço/miopexia de dois músculos)', 175);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Transposição múscular de dois músculos no estrabismo paralítico', 160);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Transposição muscular de dois músculos no estrabismo paralítico, associada a enfraquecimento/reforço de um músculo', 175);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Transposição muscular de dois músculos no estrabismo paralítico, associada a enfraquecimento/reforço de dois músculos', 225);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Extracção total ou parcial de tumor ou extracção de corpo estranho-participação de oftalmologista', 100);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Injecção retrobulbar de álcool, ar, contraste ou outros agentes de terapêutica e de diagnóstico', 9);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Injecção terapêutica na cápsula de Tenon', 9);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Inserção de implante orbitário exterior ao cone muscular (ex: reconstituição de parede orbitária) colaboração de oftalmologista com neurocirurgião e/ou otorrinolaringologista e/ou cirurgião plástico', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Extracção de chalázio ou de quisto palpebral, com anestesia geral e/ou hospitalização', 45);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Correcção de ptose: técnica do músculo frontal com sutura (ex:Op. de Friedenwald)', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Blefaroplastia extensa (ectrópio e entrópio) (ex: operações tipo Kuhnt Szymanowski e Wheeler-Fox)', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Blefaroplastia extensa para correcção da Blefarofimose e do epicantus', 150);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Sutura de ferida incisa recente envolvendo as estruturas superficiais e bordo', 40);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Sutura de ferida incisa recente envolvendo toda a espessura da pálpebra', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reconstrução e sutura de ferida lacero-contusa, envolvendo todas as estruturas da pálpebra até 1/3 da sua extensão, podendo incluir enxerto de pele, simples ou pediculado', 95);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, envolvendo mais de 1/3 do bordo', 120);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reconstrução de toda a espessura palpebral por retalho tarso-conjuntival da palpebra oposta', 140);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Dacriacistorinostomia (fistulização do saco lacrimal para a cavidade nasal)', 160);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Miringotomia com anestesia geral ou local unilateral (sob visão microscópica)', 30);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Miringotomia com anestesia geral ou local bilateral (sob visão microscópica)', 45);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Miringotomia com aplicação de tubo de ventilação unilateral (sob visão microscópica)', 50);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Miringotomia com aplicação de tubo de ventilação bilateral (sob visão microscópica)', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Timpanomastoidectomia com conservação da parede do C.A.E. com timpanoplastia', 300);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Timpanomastoidectomia sem conservação da parede do C.A.E. (com timpanoplastia)', 350);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Ressecção do pavilhão auricular sem reconstrução e sem esvaziamento ganglionar', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Reanimação cardio-respiratória e hemodinâmica em casos de paragem, shock, etc. 1ª. Hora', 35);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Estabelecimento de ventilação assistida ou controlada com intubação nasal ou orotraqueal ou traqueotomia 1º. Dia', 40);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Idem, 2º. Dia e seguintes', 20);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame ileo-cecal ou ceco-apendicular quando associado aos trânsitos cólico ou delgado', 2);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Coluna cervico-dorsal, zona de transição ­ 2 incidências (frente e obliqua)', 2);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Coluna lombo-sagrada, em carga, com inclinações (estudo funcional) 4 incidências', 6);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Coluna sagrada ­ 2 incidências', 2);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Coluna vertebral, em filme extra-longo (30X90) ­ cada incidência em carga', 4);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Localização e extracção de corpos estranhos sob controlo radioscópico (radiocirurgia) com intensificador', 10);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Localizarão de corpos estranhos intra oculares por meio de 4 imagens em posições diferentes', 10);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Localização de corpos estranhos intra oculares pelo método de Comberg (lente de contacto)', 10);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Aortografia (por punção de Reinaldo dos Santos ou por técnica de Sel dinger', 15);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Tomografia, cada incidência ou lado, mínimo 4 planos, filmes 30x40, 35x35 ou medidas superiores', 6);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Osteodensitometria por dupla energia com utilização de ampolas de Rx (coluna, femur ou esqueleto', 30);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Densitometria óssea bifotónica/DEXA com análise evolutiva (comparação)', 20);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame da região craniofacial dos seios perinasais e glândulas salivares', 50);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame cranio-encefálico com indicação para estudo das cisternas da base craniana (Fossa média e posterior)', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame cranio-encefálico com indicação para estudo de hidrocefalia', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame cranio-encefálico com indicação para estudo do hipótalamo e região optoquiasmática', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame cranio-encefálico com indicação para estudo da hipófise e veio cavernoso (incluindo situações de pós operatório)', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame cranio-encefálico com indicarão para estudo do angulo ponto cerebeloso (incluindo condutos auditivos internos)', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame cranio-encefálico com indicação para estudo do tronco cerebral (patologia tumoral, desmielinizante e vascular)', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame cranio-encefálico com indicação para estudo vascular dos territórios cerebrais e da fossa posterior', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame cranio-encefálico com indicação para estudo do aqueduto do Sylvius, região pineal e 4º. ventrículo (incluindo patologia tumoral)', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame da charneira cranio-vertebral com indicação para estudo das amígdalas cerebelosas, de transição bulbo-medular e respectivas cisternas', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame da medula com indicação para despiste de lesões de pequena dimensão (cavitações, hematomas, malformações vasculares, anomalias, doenças infecciosas desmielinizantes e tumorais)', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame da coluna lombo-sagrada com indicação para estudo das raízes nervosas e suas relações intratecais e foraminais (patologia herniária, infecciosa e tumoral)', 60);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame do ouvido (particularmente do ouvido crónico complicado, degeneres-cência labiríntica, nervo facial intra e extrapetroso, tumores do conduto e caixa timpânica)', 90);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Exame da órbita (particularmente patologia intrínseca ou extrínseca do nervo óptico e suas relações com a artéria oftálmica, tumores oculares e seu diagnóstico diferencial)', 90);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação hemodinâmica dos membros superiores - Fluxometria Doppler (arterial ou venosa)', 15);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação hemodinâmica dos membros inferiores - Fluxometria Doppler (arterial ou venosa)', 15);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação hemodinâmica arterial dos membros - Fluxometria Doppler-compressões segmentares ou provas de hiperemia', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação hemodinâmica arterial cervico-encefálica - Fluxometria Doppler', 20);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação da circulação digital com fotopletismografia', 15);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Avaliação hemodinâmica da circulação venosa dos membros com pletismografia', 15);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Angiografia ultra-sónica com análise espectral cerebrovascular carotídea', 20);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Arteriografia selectiva e embolização terapêutica, artéria carótida externa', 80);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Arteriografia selectiva e embolização terapêutica, artéria do membro', 50);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Arteriografia selectiva e embolização terapêutica, ramo visceral da aorta', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Arteriografia selectiva e dilatação percutânea do tronco arterial braquiocefálico (*)', 130);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Arteriografia selectiva e dilatação percutânea de um ramo visceral da aorta', 130);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Flebografia selectiva transhepática percutânea e embolização (Varizes gastro-esofágicas)', 80);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Uma artéria (carótida interna, externa vertebral ou cervical profunda)', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Mais que quatro artérias (inclui estudo superselectivo dos ramos carotidos)', 100);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Angiografia radiculo-medular (por cada região: cervical, dorsal ou lombar)', 100);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Suor (Determinação dos cloretos ou sódio no), após estimulação por iontoforese com pilocarpina', 1);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Prova da Clonidina com Doseamentos Hormonais', 100);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Prova de Clomifene Alargada (doseamentos de L.H.,FSH,Estradiol, Testosterona cada doseamento)', 3);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Prova de Clomifene com 2 doseamentos de H.L., 2 de FSH, 2 de Estradiol, 2 de Testosterona', 3);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Prova de Estim.Múltipla p/ TRH,LRH e Hipoglicémia (7/Glicémia, 6/STH, 5/Cortiso1,4/PRL, 4/FSH, 4/L, 5/ACTH', 8);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Prova de Estimulaqão Múltipla alarg. pelo TRH,LRH e Hipoglic.c/dos.PRL, TSH,FSH,LH,ACTH,Cortisol cada', 8);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Prova de Glucagon com doseamentos de STH-cada doseamento', 3);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Prova de Hipoglicémia Insulinica (I.V.) com doseamentos hormonais, cada determinação', 8);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Prova de Hiperglicémia provocada com doseamentos de insulina simultâneos, cada', 3);
INSERT INTO ProcedureType VALUES (DEFAULT, 'Suco Gástrico-Prova de Estimulação pela Hipoglicemia induz. pela insulina', 3);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Qualquer destas modalidades terapêuticas quando feita em grupo (máximo de 6 doentes)', 1);
...
INSERT INTO ProcedureType VALUES (DEFAULT, 'Fortalecimento muscular/mobilização articular com monitorização contínua', 5);
