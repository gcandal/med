...
{if $EMAIL}
                        ...
                        <div class="panel-body">
                            <table class="table table-hover" id="sample-table-1">
                                ...
                                <tr>
                                    ...
                                    <th class="center hidden-xs">Telefone</th>
                                    <th class="center">Nº de beneficiário</th>
                                    <th class="center"></th>
                                </tr>
                                </thead>
                                <tbody>
                                ...
                                {foreach $PATIENTS as $patient}
                                    <tr>
                                        <td>{$patient.name}</td>
                                        <td class="center hidden-xs">{$patient.nif}</td>
                                        <td class="center hidden-xs">{$patient.cellphone}</td>
                                        <td class="center">{$patient.beneficiarynr}</td>
                                        <td class="center">
                                            <div class="visible-md visible-lg hidden-sm hidden-xs">
                                                <form class="inlineForm"
                                                      action="{$BASE_URL}pages/patients/editpatient.php">
                                                ...
                                                <form class="inlineForm"
                                                      action="{$BASE_URL}actions/patients/deletepatient.php"
                                                      method="post">
                                                    <input type="hidden" name="idpatient"
                                                           value="{$patient.idpatient}"/>
    ...
    <!-- end: PAGE -->
    <span style="display: none" id="activeTab">patients</span>
{else}
